...
export class OnglesComponent {
  /** carousel content */
    slides: Array<any> = [
      {
        title: 'Ongles Marrakech : manucure gel, semi-permanent et designs durables',
        subtitle: '',
        description: `À Marrakech, les ongles sont souvent mis à l’épreuve : chaleur, activités, soirées, travail, voyages, mariages… Beaucoup de clientes nous disent que leur gel ne tient pas, que leurs ongles cassent ou que le semi-permanent se décolle trop vite.
                      Chez Russiaville Beauty, on voit ces problèmes tous les jours. Notre méthode est simple : renforcer l’ongle naturel, choisir les bons produits et adapter la technique au climat de Marrakech.
                      Que vous veniez de Guéliz, Majorelle, Hivernage ou Sidi Ghanem, nos prestations ongles sont pensées pour tenir malgré la chaleur, l’humidité et les journées chargées.
                      Les clientes posent souvent les mêmes questions :
                      “Le gel va tenir malgré la chaleur ?”
                      “J’ai les ongles cassants, c’est possible de les renforcer ?”
                      “Est-ce que les extensions gel sont solides ?”
                      “Le semi-permanent tient combien de temps ici ?”
    ...
    data : ContentSectionData= {
      ...
      description : "La manucure gel est la prestation la plus demandée à Marrakech. Le gel offre une tenue longue, une brillance stable et une base solide pour les ongles fragiles. Beaucoup de clientes choisissent le gel avant un mariage, un voyage ou une période chargée.",
      buttonText : "Réserver",
      buttonLink : "Réserver",
      leftImage : {
        id : "1",
    ...
    accordionData: AccordionDataType = [
        {
          ...
          points: ['tenue longue, même avec la chaleur', 'renforcement de l’ongle naturel', 'brillance durable' , 'correction des ongles mous ou cassants' , 'large choix de couleurs et de finitions']
        },
        {
          title: 'Pour qui ?',
          points: ['ongles cassants', 'ongles qui se dédoublent' , 'clientes actives' , 'femmes qui veulent un résultat durable' , 'clientes qui préparent un événement (mariage, fête, voyage)']
        }
      ];
     ...
     servicesAbout: any[] = [
      {
        ...
        description: 'Le semi-permanent est idéal pour celles qui veulent un rendu fin, léger et naturel. C’est un choix parfait si vous cherchez quelque chose de simple mais propre.',
        features: [
        ...
        imagePosition: 'left',
        conseil : 'Conseil : hydrater les cuticules, limer doucement entre les rendez-vous, éviter les produits trop gras' 
      },
    ...
    highlightData: any = {
      ...
      imagePosition: 'right',
      conseil : 'Conseil : Éviter les chocs directs pour ne pas affaiblir la construction.'
    };
    ...
    */
     ...
     servicesDepose: any[] = [
      {
        ...
        subtitle: '',
        title: 'Dépose ongles Marrakech',
        description: 'La dépose doit être douce pour ne pas abîmer l’ongle naturel. Beaucoup de clientes viennent avec des ongles fragilisés à cause de dépôts mal faits ailleurs. Notre approche:',
        features: [
          'Limage léger',
          'Produit adapté',
          'Aucune traction',
        ...
        imagePosition: 'left',
        conseil : 'Conseil : Ne jamais tirer sur le gel à la maison. Cela abîme fortement la plaque de l’ongle.' 
      },
    ...
    // Section 7
      ...
      textSecond : "Le nail art est très demandé pour les fêtes, voyages, shootings ou soirées. Pour qui ?",
      featuresSecond : [
      ...
      imageAlt: 'soin beauté ongles cils sourcils',
      imagePosition: 'right',
      conseil : 'Conseil : Choisir un design adapté à votre longueur d’ongle pour un rendu harmonieux.'
    };
    ...
    ctaData : CtaBannerDataType = {
          subtitle : "",
          title : "",
          description : "Si vous cherchez une manucure propre, durable et adaptée au climat de Marrakech, vous pouvez nous écrire pour connaître les disponibilités ou poser vos questions.",
          buttonText : "",
          buttonLink : "",
    }
