...
export class DeposeExtensionsCilsComponent {
  ...
  servicesAbout: ServiceAbout | any = {
    ...
    image: 'assets/images/instagramImages/cilsstk.jpg',
  ...
  highlightData: any = {
    ...
    image: 'assets/images/instagramImages/cils1.jpg',
  ...
  ngOnInit(): void {
    ...
    const seo = this.seoService.getSeoForService('serviceDeposeDeCils');
