...
export class EpilationSourcilsComponent {
  ...
  slides: Array<any> = [
    {
      title: 'Épilation sourcils Marrakech : une ligne propre et naturelle',
      subtitle: '',
      description: `
  ...
  servicesAbout: ServiceAbout | any = {
    ...
    features: [
      ...
      {
        title:
          '5. Possibilité d’ajouter une restructuration ou une teinture sourcils',
        points: [
    ...
    features: [
      {
        ...
        points: [
          'La prestation offre un coup de frais immédiat : vos sourcils retrouvent une ligne nette sans effort.',
        ],
        smallDesc: '',
      },
      {
        ...
        points: [
          'On travaille la ligne en suivant la direction naturelle du poil et la structure du visage pour un résultat équilibré.',
        ],
        smallDesc: '',
      },
      {
        ...
        points: [
          'L’épilation est réalisée avec une technique douce, ce qui limite au maximum l’inconfort.',
        ],
        smallDesc: '',
      },
      {
        ...
        points: [
          'La forme conserve sa netteté plusieurs semaines, même avec la chaleur ou un rythme actif.',
        ],
        smallDesc: '',
      },
      {
        ...
        points: [
          'Un excellent choix avant une séance photo, un événement ou un voyage pour des sourcils impeccables.',
        ],
        smallDesc: '',
      },
    ],
    ...
    features: [
      {
        ...
        points: ['Non, la repousse reste naturelle.'],
        smallDesc: '',
      },
      {
        title: 'Cire ou pince ?',
        points: ['On choisit selon votre peau.'],
        smallDesc: '',
      },
    ],
