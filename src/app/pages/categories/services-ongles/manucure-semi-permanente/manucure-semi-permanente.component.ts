...
export class ManucureSemiPermanenteComponent {
  ...
  slides: Array<any> = [
    {
      ...
      subtitle: '',
      description: `
                                      Beaucoup de clientes de Guéliz, Majorelle et Hivernage viennent nous voir parce qu’elles veulent des sourcils disciplinés, 
                                      qui tiennent toute la journée malgré la chaleur de Marrakech. Le brow lamination Marrakech aide à redresser les poils, 
                                      remplir les zones clairsemées et structurer le regard sans maquillage.
                                    `,
      buttonText: 'Réserver',
  ...
  slideImage: string =
    'assets/images/instagramImages/ongle4.jpg';
  ...
  highlightData: any = {
    ...
    image: 'assets/images/instagramImages/ongle11.jpg',
